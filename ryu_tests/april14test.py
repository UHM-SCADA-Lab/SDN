...
class SimpleSwitch13(app_manager.RyuApp):
    ...
    def _packet_in_handler(self, ev):
        ...
        self.logger.info(log_format_address.format(data_type='MAC',src_address=src, dst_address=dst, info='Buffer',value=has_buffer))
        ...
        self.logger.info(log_format_address.format(data_type='Port',src_address=in_port, dst_address=out_port, info='',value=''))
        self.logger.info(log_format_address.format(data_type='DPID',src_address=str(hex(dpid))[2:],dst_address='',info='',value=''))
